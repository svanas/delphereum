...
begin
  ...
  begin
    Result := TResult<TAddress>.Err('not a legacy transaction');
    EXIT;
  end;
...
begin
  ...
  begin
    Result := TResult<TAddress>.Err('not an EIP-1559 transactionn');
    EXIT;
  end;
...
begin
  ...
  Result := TResult<TAddress>.Err('unknown transaction encoding');
end;
